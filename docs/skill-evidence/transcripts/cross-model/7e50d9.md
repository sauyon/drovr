...
Reasoning: Meera spent her afternoon on this, has a clear conclusion with supporting arithmetic, and her fix + regression test are ready. Building the harness (option B) would validate her but is essentially paying two hours of overlap on top of what she already delivered. Option C's per-customer switch adds complexity for marginal gain when you're not certain her conclusion is wrong.

I'm merging now and watching the drop rate for a day.
